 ...
 */
public class PassengersDepartController extends PassengersGUI{

    public PassengersDepartController(){
        setChoosedTypeStr(instPassengersSortService.getDepartureTypeStr());
    }
